...
using Utils.Enhancement.Interop;
...
namespace Utils.Enhancement
{
    ...
    public sealed class VistaFolderBrowserDialog
    {
        ...
        /// </value>
        [Browsable(true), Editor("System.Windows.Forms.Design.SelectedPathEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(object)), Description("The path selected by the user."), DefaultValue(""), Localizable(true), Category("Folder Browsing")]
        ...
        private bool RunDialogDownlevel(IntPtr owner)
        {
            ...
            if (NativeMethods.SHGetSpecialFolderLocation(owner, RootFolder, ref rootItemIdList) != 0)
            {
                ...
                {
                    throw new InvalidOperationException("无效的根目录");
                }
            }
            try
            {
